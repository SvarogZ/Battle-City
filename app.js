...
class Tank extends Mesh {
	...
	draw(){
		...
		this.ctx.fillRect(this.x-this.width/2, this.y-this.height/2, this.width/2, this.height/2);
	}
...
function drawObjects(ctx,timeDelta){
